...
Combust is a rebuild of [hydra](https://github.com/erikh/hydra) in Rust, designed for future expansion.
...
See [contrib/README.md](contrib/README.md) for `Makefile.tmux`, which runs combust tasks in parallel tmux windows.
